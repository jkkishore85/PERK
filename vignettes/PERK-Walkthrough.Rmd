...
![Figure 1. PERK: Workflow.](img/perk_workflow.png){#fig-workflow}
...
![Figure 2. PERK: Features](img/perk_features.png){#fig-features}


# Upload Data {#sec-upload-data}

![Figure 3. PERK: Upload Data](img/datainput.png){#fig-upload-data}
...
![Figure 4. Predicted: Prescription - AV Panel.](img/predicted01.png){#fig-predicted01}
...
![Figure 5. PC: kg/month.](img/prescplot01-1.png){#fig-prescraw}

![Figure 6. PC: PNDP.](img/prescplot02-1.png){#fig-prescpndp}

# Predicted: Predicted Concentration {#sec-pred-pec}

![Figure 7. Predicted: Predicted Concentrations - AV Panel.](img/predicted02.png){#fig-predicted02}
...
::: {layout-ncol="2"}
![Figure 8. PC: concentration/month.](img/predplot01-1.png){#fig-predicted03}

![Figure 9. PC: concentration/period.](img/predplot02-1.png){#fig-predicted04}
:::
...
![Figure 10. Measured: Measured Concentrations - AV Panel.](img/measured01.png){#fig-measured01}
...
::: {layout-ncol="2"}
![Figure 11. MC: concentration/month.](img/mcplot01-1.png){#fig-mcmonth}

![Figure 12. MC: concentration/period.](img/mcplot02-1.png){#fig-mctotal}
:::
...
![Figure 13. Predicted vs Measured: Predicted vs Measured - AV Panel.](img/pcvsmc01.png){#fig-pcsvsmc01}
...
::: {layout-ncol="2"}
![Figure 14. PCvsMC: PEC-I.](img/pcvsmcplot01-1.png){#fig-pcvsmcplot1}

![Figure 15. PCvsMC: PEC-II.](img/pcvsmcplot02-1.png){#fig-pcvsmcplot2}
:::
...
![Figure 16. Predicted vs Measured: Prediction Accuracy - AV Panel.](img/pcvsmc02.png){#fig-pcsvsmc02}
...
![Figure 17. PCvsMC: PA-I.](img/paplot01-1.png){#fig-paplot01}
